...
quartz-gfx-mesh-stack is a Dart project for graphics. It focuses on this technical goal: Design a Dart verification harness for mesh systems, covering policy evaluation, deny and allow fixtures, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 180, risk penalty 7, latency penalty 3, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
