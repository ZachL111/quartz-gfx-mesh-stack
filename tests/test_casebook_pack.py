"""Regression checks for the quartz-gfx-mesh-stack casebook."""
...
from casebook.harness import assert_expected, quartz_gfx_mesh_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(quartz_gfx_mesh_stack_summary(), assert_expected())
