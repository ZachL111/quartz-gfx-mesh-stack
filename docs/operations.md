...
`quartz-gfx-mesh-stack` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for mesh systems, covering policy evaluation, deny and allow fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 180. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 4.
